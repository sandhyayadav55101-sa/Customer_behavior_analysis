...
--Q5 Do described customers spend more? compare average spent and total revenue between subscribers and non-subscribers.
...
--Q8 what are the top 3 most purchase prodcts with each category?
with item_counts as(
select category,
item_purchased,
...
--Q 10 what is the revenue contribution of ech age group?
select age_group,
